...
export const CHANGELOG = [
  {
    ...
    date: "2026-09-04",
    tr: [
      "🗺️ SEKTÖR AYIRICILARI TAKIMA HİÇ ULAŞMIYORDU. Pisti süren editörün ekranında S1/S2 sınırları görünüyor ama takım arkadaşlarına ASLA yazılmıyordu — paylaşım 2 saniyelik bir bekleme sonrası yapılıyor, o bekleme her canlı karede (saniyede iki kez) sıfırlandığı için hiç dolmuyordu. İzleyiciler bu yüzden ayırıcıları hep \"gözlem yok\" diye boş görüyordu.",
      "🌍 İNGİLİZCE ARAYÜZDE 107 METİN TÜRKÇE KALIYORDU; ayrıca yükleme ekranları \"Loading…\" yerine \"Uploading…\" yazıyordu. Sebep: sözlükte aynı anahtarın ikinci yazımı birincisini sessizce siliyordu (24 yerde; üçünde anlam değişiyordu). Sol menü, komut paleti başlıkları, takım ekranı, yakıt senaryoları ve telemetri durum metinleri artık çevrili. Bu hataya bir daha düşülmemesi için sözlük denetimi teste bağlandı.",
      "🎨 AÇIK TEMA YARIM KALMIŞTI. Sayfa zemini ve birkaç kart aydınlanıyor, ama nav rayı, üst çubuk, modallar, komut paleti ve TÜM sekme içerikleri koyu kalıyordu — çünkü uygulamanın çizim renkleri (2551 kullanım) için açık tema karşılığı hiç tanımlanmamıştı. 67 renk eklendi; metin kontrastları WCAG AA eşiğine göre ölçülüp teste bağlandı. Ayrıca pist haritasındaki \"PIT OUT\" işareti açık temada beyaz üstüne beyaz çizildiği için TAMAMEN GÖRÜNMEZDİ.",
      "🚩 BEKLEYEN CEZASI OLAN ARAÇ \"—\" GÖSTERİYORDU, yani \"cezası yok\" diyordu. Köprü yarış ortasında başlatıldığında (yeniden başlatma, yazıcı devri, uygulamanın sonradan açılması) kümülatif sayaç sıfırdan başlıyor ve o anda drive-through bekleyen araçlar boş görünüyordu; bilgi yalnız fare üstüne gelince çıkıyordu.",
      "🟣 \"EN İYİ\" SÜTUNUNDAKİ MOR ARTIK SINIF REKORU. Saha genelinin en hızlısına bakıyordu, oysa aynı ekranda sektör hücresi ve satır parlaması moru sınıf rekoru için kullanıyor — çok sınıflı LMU sahasında hiçbir GT3 satırı mor olamıyordu. Ayrıca RELATIVE penceresi artık \"kendi sınıfım\" süzgecinden etkilenmiyor: undercut penceresi ve mavi bayrak kararları tam olarak diğer sınıf trafiğiyle ilgili, süzgeç açıkken o araçlar gizleniyordu.",
      "📊 KAYITLI TELEMETRİ İZİNİN KÜNYESİ SAYFA YENİLENİNCE KAYBOLUYORDU (pist/araç/pilot/sıcaklık satırı ve PDF künyesi boş kalıyordu). Daha önemlisi \"farklı pist — kıyas dikkatli\" uyarısı kayıtlı izlerde HİÇ çıkamıyordu: kayıtlı bir Spa stintini yüklü bir Monza dosyasıyla uyarısız karşılaştırabiliyordunuz. Ayrıca aynı .duckdb dosyası ikinci kez seçilemiyordu (hiçbir tepki vermiyordu) ve açılan her dosya oturum boyunca bellekte kalıyordu.",
      "📏 TELEMETRİ İZİNDE her turun son örneği S/F çizgisine denk geldiği için oyunun gerçek mesafe kanalı çöpe atılıp mesafe hızdan modelleniyordu; aynı stintte bazı turlar gerçek, bazıları modellenmiş mesafeyle ölçekleniyor ve iz karşılaştırması sessizce tutarsızlaşıyordu. Seans süresi de saat kanalı yokken yanlış kanaldan hesaplanıp yarıya düşebiliyordu.",
      "🧾 ÜÇ KÜÇÜK AMA CAN SIKICI HATA: pit'i olmayan bir plan (kısa sprint) \"Planımdan ekle\" ile eklenince \"eksik veri\" damgası yiyip hiç hesaplanmıyordu · \"Pitleri sıfırla\" elle girdiğiniz TAMİR SÜRELERİNİ de siliyordu (onay penceresi bunu söylemiyor ve geri alınamıyor) · tarihi çözülemeyen bir resmi yarış \"sıradaki yarış\" olarak kilitlenip hero kartında \"01.01.1970 · 0 dk\" gösteriyor ve gerçek sıradaki yarışı gizliyordu.",
      "🔄 GÜNLÜK TAZELENEN REFERANS TUR ZAMANLARI SÜRÜM ÇIKANA KADAR DONUYORDU. Servis worker bu veri dosyasını statik varlık gibi önbelleğe alıyordu; \"Ohne Speed\" tempo tablosu ve Strateji Karşılaştırma'nın pist/sınıf önerileri sürümler arası bayat kalıyordu. Ayrıca hesap değiştirince seçili takım sıfırlanmıyor, kullanıcı üyesi olmadığı takım seçiliyken boş liste görüyordu; pilot programında \"· N tur\" hiç görünmüyordu.",
      "🌐 KÖPRÜDE AĞ BOZULUNCA CANLI YAYIN NEREDEYSE DURUYORDU. Tur geçmişi yazımı başarısız olunca geri çekilmeden her karede yeniden deneniyor ve 15 saniyelik zaman aşımı canlı kareyi de blokluyordu — yayın saniyede 2 kareden ~16 saniyede 1 kareye düşüyordu, üstelik pit duvarının canlı veriye en çok ihtiyaç duyduğu anda. Ayrıca oyun PC'sinde dakikada bir tüm süreç listesi taranıyordu ve köprü kapanışında paylaşımlı bellek eşlemeleri aslında hiç kapanmıyordu.",
      "🛞 LASTİK AŞINMA ÖLÇÜMÜ ARTIK KÖPRÜNÜN TUR TUR KAYDINDAN GELİYOR. Köprü bu veriyi zaten her tur yazıyordu ama hiçbir ekran okumuyordu. Yeni ölçüm KISMİ değişimi de çözüyor (yalnız ön ikili değiştiğinde de çalışır) ve hızı iki gerçek okuma arasındaki farktan alıyor — eski hesap dişin stint başında tam dolu olduğunu varsaydığı için stint ortasında yakalanan sette hızı şişiriyordu. Buton ipucu artık en kritik köşeyi ve o köşeye göre kalan turu da yazıyor.",
      "🔒 GİZLİLİK AÇIĞI KAPATILDI — onaylı bir kullanıcı, KATILIM KODUNU BİLMEDEN istediği takıma girebiliyordu. İki eksik birleşiyordu: katılım kodu tablosu bütün olarak okunabildiği için tek istekle TÜM takımların kimliği dökülüyor, üyelik kuralı da kod ispatı istemiyordu. Uygulama kodu doğruluyordu ama bu yalnız tarayıcı tarafındaydı — konsoldan atlatılabiliyordu. Giren kişi o takımın TÜM STRATEJİ PLANINI, sohbetini ve canlı verisini okuyabiliyordu. Artık kod tablosundan yalnız BİLİNEN tek kod okunabiliyor (liste dökülmüyor) ve üyelik, girilen kodun takımın gerçek koduyla eşleştiğini sunucu tarafında ispatlamayı şart koşuyor. Mevcut üyeler, rol değişimi, takımdan ayrılma ve yeni takım kurma etkilenmedi — 74 kural testiyle doğrulandı.",
      "💾 VERİ KAYBI DÜZELTİLDİ — bir yarışta hücre düzenleyip hemen başka yarışa geçince O YARIŞIN PLANI HERKESTE KAYBOLUYORDU. Uygulama düzenlemeleri 0,8 sn bekletip toplu yazar; bekleyen yazım oda değişince iptal edilmiyordu ve ateşlendiğinde YENİ odanın verisini ESKİ odanın yoluna yazıyordu. Sürüm numarası arttığı için eski odadaki diğer mühendislerin ekranı da bunu \"yeni sürüm\" sanıp uyguluyor, plan her cihazda gidiyordu. Artık oda değiştirirken bekleyen düzenleme önce MEVCUT odaya gönderiliyor (kaybolmuyor), sonra zamanlayıcı iptal ediliyor.",
      "🔁 İKİ MÜHENDİS AYNI ANDA DÜZENLEYİNCE BİRİ SESSİZCE KAYBOLUYORDU. Sürüm numarası sunucuda değil tarayıcıda üretildiği için ikisi de aynı numarayı yazıyor, sunucuda biri kalıyordu. Kaybeden tarafın ekranı kazananın yazdığını HİÇ uygulamıyor, üstte \"senkron\" yazmaya devam ediyor ve bir sonraki düzenlemesi diğerinin işini siliyordu. Artık kendi yazımının damgası tutuluyor: aynı sürümde başkasının yazımı gelirse fark ediliyor ve uygulanıyor.",
      "🧟 \"ÇALIŞIYOR\" DİYEN AMA HİÇ VERİ YAZMAYAN KÖPRÜ. Köprü başlarken yarış/takım değiştirilirse eski başlatma askıda kalıp süreci YİNE DE doğuruyor, ama durdurma bayrağı açık kaldığı için tek kare bile göndermiyordu. Oyun PC'sinde paylaşımlı bellek okuyan bir süreç dönüyor, arayüz \"çalışıyor\" diyor, canlı timing hiç gelmiyor — ve köprü \"çalışır\" göründüğü için otomatik yeniden deneme de onu canlandırmıyordu. Ayrıca eski sürecin kapanışı YENİ köprünün aboneliklerini ve yazma kirasını siliyordu (iki yazıcı, ekran kare kare yanıp sönüyor). Her başlatma artık kendi kimliğini taşıyor; eskisi yenisine dokunamıyor.",
      "🧮 \"PLANIMDAN EKLE\" KENDİ PLANINI OLDUĞUNDAN HIZLI YAZIYORDU. Plan motoru son stinte bayrak turunu TUR SAYISINA ekliyor ama o turun SÜRESİNİ eklemiyor; ortalama tur bu ikisinin bölümünden çıkarıldığı için sonuç sistematik olarak hızlı geliyordu. Ölçüldü: girdiğiniz 2:02.500 → satıra 2:00.457 yazılıyordu, 24 saatlik planda 3:29.000 → 3:25.907. Rakip satırını elle girdiğinizde karşılaştırma size SAHTE bir avantaj gösteriyordu. Artık ortalama tur bayrak turu taşımayan stintlerden türetiliyor ve girdiğiniz turu birebir geri veriyor.",
      "⛽ SON STİNTE HIZLI TUR GİRİNCE PLAN BİR TUR EKSİK YAKIT SÖYLÜYORDU. Son durağın dolum yüzdesi kalan turu YARIŞ ORTALAMASIYLA hesaplıyordu; oysa aynı hesap stinte özel VE tüketimini zaten dikkate alıyor. Son stinte ortalamadan hızlı bir tur yazınca kalan tur bir eksik sayılıyordu — yarışta yakıtsız kalmak demek. Ters yönde de gereksiz fazla dolum ve boşa pit süresi çıkıyordu. Artık stintin kendi tur süresi kullanılıyor.",
      "🛞 LASTİK PLANI GERÇEKLE BİR KAYIK EŞLEŞİYORDU. S1 satırı yarış ÖNCESİ takılan settir, arkasında pit yoktur — ama \"pit değişimi\" sayılıyordu. Sonuç: plana TAM uyduğunuz bir yarışta ekran \"1 sapma\" gösteriyor, \"Plandaki lastik değişimi\" KPI'sı yarış öncesi takmayı da ücretlendiriyordu (ölçüldü: +28.5 sn yerine gerçek +16.5 sn). Ayrıca plan kısalınca ızgarada kalan eski stintler de sayıya giriyor, ve S2'ye S1'dekiyle aynı seti yazınca plan 0 sn derken KPI 12 sn yazıyordu. Üçü de düzeldi: değişimler artık planın kendi pit bayraklarından okunuyor, yani KPI ile plan aynı kaynaktan besleniyor.",
      "🏁 CANLI TIMING'DE RELATIVE SIRASI ÇOK SINIFLI SAHADA KARIŞIYORDU. Fark saniyesi sizin tur sürenizle hesaplanırken sıralama RAKİBİN tur süresine bölünüyordu; her satır farklı ölçekle normalize edildiği için REL sütunu yukarıdan aşağı düzgün sıralanmıyor ve ±3 penceresine yanlış araç giriyordu. LMU'da saha her zaman çok sınıflı (Hypercar ~1:35 · LMGT3 ~1:50) olduğu için bu her yarışta oluyordu.",
      "📉 LASTİK/HASAR VERİSİ ONLINE'DA SIFIRLANIYORDU. Köprü telemetri dizisini yanlış sayaçla tarıyordu: oyun telemetriyi skorbordan az araç için yayınladığında yazılmamış boş slotlar da taranıyor ve GERÇEK bir aracın lastik/hasar/yakıt verisinin üzerine yazılıyordu — o araç için diş %0, aşınma 0, hasar 0 görünüyordu. Yani oyunun vermediği bir veri \"sıfır\" diye uydurulmuş oluyordu ve bu sahte değerler kalıcı aşınma geçmişine de yazılıyordu.",
      "📏 TELEMETRİDE HER TURDA OYUNUN GERÇEK MESAFE KANALI ÇÖPE ATILIYORDU. Turun son örneği tam S/F çizgisine denk geldiği için oyunun \"tur mesafesi\" kanalı orada sıfırlanıyor; bu \"mesafe geriye gitti\" sanılıp TÜM tur hızdan yeniden modelleniyordu. S/F geçişinin örnekleme ızgarasına düşme noktası turdan tura kaydığı için aynı stintte bazı turlar gerçek, bazıları modellenmiş mesafeyle ölçekleniyor ve iz karşılaştırması sessizce tutarsızlaşıyordu. Turun ORTASINDAKİ gerçek bir bozulma hâlâ hız yedeğine düşüyor.",
      "🧊 `--no-rest` BAYRAĞI ARAYÜZ YOLUNDA ÇALIŞMIYORDU. Oyun donuyorsa LMU REST'i kapatmak için var olan bu bayrak, çift tıklamayla açılan varsayılan yolda ve `--dump` / `--dump-wx` teşhis komutlarında sessizce yok sayılıyordu — yani \"donuyor mu\" diye bakan teşhis komutu donmanın bilinen sebebini kendisi tetikliyordu. Artık her yolda geçerli; köprü penceresi ve günlüğü gerçek REST durumunu yazıyor. (REST'in arayüzde varsayılan AÇIK olması korundu; belgeler de bugünkü gerçeğe göre güncellendi.)",
    ],
    en: [
      "🗺️ SECTOR MARKERS NEVER REACHED THE TEAM. The editor driving the track saw the S1/S2 boundaries on their own screen, but they were NEVER written for team-mates — sharing waits two seconds, and that wait was reset by every live frame (twice a second), so it never elapsed. Viewers therefore always saw \"no observation\" instead of the markers.",
      "🌍 107 STRINGS STAYED IN TURKISH IN THE ENGLISH UI, and loading screens read \"Uploading…\" instead of \"Loading…\". The cause: a second entry for the same dictionary key silently deleted the first (24 of them; three changed meaning). The left rail, command-palette headings, the team screen, fuel scenarios and telemetry status text are now translated. A dictionary check is now wired into the tests so this cannot happen again.",
      "🎨 THE LIGHT THEME WAS HALF-FINISHED. The page background and a few cards turned light, but the nav rail, top bar, modals, command palette and ALL tab content stayed dark — because the app's drawing colours (2551 usages) had no light-theme values at all. 67 colours were added, and the text contrasts are measured against the WCAG AA threshold in a test. The \"PIT OUT\" marker on the track map was also drawn white-on-white in the light theme, making it COMPLETELY INVISIBLE.",
      "🚩 A CAR WITH A PENDING PENALTY SHOWED \"—\", i.e. \"no penalty\". When the bridge is started mid-race (a restart, a writer handover, opening the app later) the cumulative counter starts from zero, so cars serving a drive-through appeared blank; the information was only in the tooltip.",
      "🟣 PURPLE IN THE \"BEST\" COLUMN IS NOW THE CLASS RECORD. It compared against the fastest of the whole field, even though the sector cell and the row flash on the same screen use purple for the class record — in a multi-class LMU field no GT3 row could ever be purple. The RELATIVE window is also no longer affected by the \"my class only\" filter: undercut windows and blue-flag calls are precisely about other-class traffic, which the filter was hiding.",
      "📊 THE HEADER OF A SAVED TELEMETRY TRACE DISAPPEARED ON RELOAD (track/car/driver/temperature line and the PDF header went blank). More importantly the \"different track — compare with care\" warning could NEVER fire for saved traces: you could compare a saved Spa stint against a loaded Monza file with no warning. Also, the same .duckdb file could not be picked a second time (nothing happened at all), and every opened file stayed in memory for the whole session.",
      "📏 IN TELEMETRY TRACES the last sample of each lap lands on the start/finish line, so the game's real distance channel was discarded and distance was modelled from speed instead; within one stint some laps were scaled by real distance and others by a modelled one, and trace comparison drifted silently. Session length was also computed from the wrong channel when no clock channel exists, and could come out half as long.",
      "🧾 THREE SMALL BUT ANNOYING BUGS: a plan with no pit stops (a short sprint) added via \"Add from my plan\" was flagged as \"missing data\" and never calculated · \"Reset pit stops\" also deleted the REPAIR TIMES you had typed (the confirmation doesn't mention it and there is no undo) · an official race whose date could not be parsed locked itself in as \"next race\", showing \"01.01.1970 · 0 min\" on the hero card and hiding the real next race.",
      "🔄 THE DAILY-REFRESHED REFERENCE LAP TIMES WERE FROZEN UNTIL A NEW RELEASE. The service worker cached that data file like a static asset, so the \"Ohne Speed\" pace table and the Strategy Comparison track/class suggestions went stale between versions. Also, switching accounts did not reset the selected team, so you could sit on a team you are not a member of and see an empty list; and \"· N laps\" never appeared in the driver schedule.",
      "🌐 WHEN THE NETWORK DEGRADED, THE BRIDGE'S LIVE FEED ALL BUT STOPPED. A failed lap-history write was retried every single frame with no back-off, and its 15-second timeout blocked the live frame too — the feed dropped from 2 frames per second to roughly 1 every 16 seconds, exactly when the pit wall needs live data most. The game PC was also scanning the full process list once a minute, and the bridge's shared-memory mappings were never actually closed on shutdown.",
      "🛞 TYRE WEAR MEASUREMENT NOW COMES FROM THE BRIDGE'S LAP-BY-LAP LOG. The bridge was already writing this data every lap, but no screen read it. The new measurement also resolves PARTIAL changes (it works when only the fronts are swapped) and takes the rate from the difference between two real readings — the old calculation assumed the tread was full at the start of the stint, which inflated the rate for a set picked up mid-stint. The button's tooltip now also names the limiting corner and the laps left on it.",
      "🔒 A PRIVACY HOLE IS CLOSED — an approved user could join any team WITHOUT KNOWING ITS JOIN CODE. Two gaps combined: the join-code table was readable as a whole, so a single request dumped the identity of EVERY team, and the membership rule never asked for proof of the code. The app did check the code, but only in the browser — it could be bypassed from the console. Whoever got in could read that team's ENTIRE STRATEGY PLAN, its chat and its live data. Only a single KNOWN code can now be read from the table (no listing), and membership requires server-side proof that the code entered matches the team's real one. Existing members, role changes, leaving a team and creating a new one are unaffected — verified by 74 rules tests.",
      "💾 DATA LOSS FIXED — editing a cell in one race and immediately switching to another WIPED THAT RACE'S PLAN FOR EVERYONE. The app batches edits behind a 0.8 s delay; the pending write was not cancelled on room change and, when it fired, wrote the NEW room's data to the OLD room's path. Because the revision number went up, other engineers in the old room treated it as a newer version and applied it, so the plan vanished on every device. Switching rooms now first sends the pending edit to the CURRENT room (so it isn't lost), then cancels the timer.",
      "🔁 TWO ENGINEERS EDITING AT ONCE — ONE SIDE VANISHED SILENTLY. The revision number is produced in the browser rather than on the server, so both writes claimed the same number and one survived. The losing side never applied the winner's write, kept showing \"in sync\", and its next edit deleted the other's work. Each client now remembers the timestamp of its own write: if a write from someone else comes back at the same revision, it is recognised and applied.",
      "🧟 A BRIDGE THAT SAID \"RUNNING\" BUT WROTE NOTHING. If the race or team changed while the bridge was starting, the pending start still spawned the process but the stop flag stayed set, so not a single frame was sent. A process reading shared memory kept running on the game PC, the UI said \"running\", live timing never arrived — and because the bridge looked alive, the automatic retry never revived it. On top of that, the old process's shutdown cancelled the NEW bridge's subscriptions and write lease (two writers, screen flickering frame by frame). Each start now carries its own identity; an old one cannot touch a new one.",
      "🧮 \"ADD FROM MY PLAN\" WROTE YOUR PACE FASTER THAN IT IS. The plan engine adds the flag lap to the LAP COUNT of the final stint but not its DURATION; since the average lap is derived from those two, the result came out systematically fast. Measured: an entered 2:02.500 landed as 2:00.457, and 3:29.000 as 3:25.907 on a 24-hour plan. Against a hand-entered rival row, the comparison showed you a FAKE advantage. The average lap is now derived from the stints that carry no flag lap and reproduces your entered lap exactly.",
      "⛽ A FAST FINAL STINT MADE THE PLAN CALL FOR ONE LAP TOO LITTLE FUEL. The last stop's fill percentage worked out the remaining laps from the RACE AVERAGE, even though the same calculation already honours the stint's own energy consumption. Entering a lap faster than the average for the final stint counted one lap short — running dry in the race. In the other direction it meant needless overfilling and wasted pit time. The stint's own lap time is now used.",
      "🛞 THE TYRE PLAN LINED UP ONE STOP OFF AGAINST REALITY. The S1 row is the set fitted BEFORE the race, with no pit stop behind it — but it was counted as a pit change. So a race you followed EXACTLY showed \"1 deviation\", and the \"planned tyre changes\" KPI charged you for the pre-race fitment (measured: +28.5 s instead of the real +16.5 s). Leftover grid rows from a shortened plan were also counted, and writing the same set into S2 as S1 showed 12 s in the KPI while the plan said 0 s. All three are fixed: changes are now read from the plan's own pit flags, so the KPI and the plan share one source.",
      "🏁 RELATIVE ORDER SCRAMBLED IN A MULTI-CLASS FIELD. The gap in seconds was computed against YOUR lap time while the ordering divided by the RIVAL'S, so every row was normalised on a different scale: the REL column was not properly ordered top to bottom and the wrong car could enter the ±3 window. LMU fields are always multi-class (Hypercar ~1:35 · LMGT3 ~1:50), so this happened in every race.",
      "📉 TYRE AND DAMAGE DATA READ AS ZERO ONLINE. The bridge scanned the telemetry array with the wrong counter: when the game publishes telemetry for fewer cars than the scoreboard, unwritten empty slots were scanned too and overwrote a REAL car's tyre/damage/fuel data — that car showed 0% tread, 0 wear, 0 damage. A value the game never provided was being invented as \"zero\", and those fake numbers were written into the persistent wear history as well.",
      "📏 THE GAME'S REAL DISTANCE CHANNEL WAS DISCARDED ON EVERY LAP. The last sample of a lap falls exactly on the start/finish line, where the game's \"lap distance\" channel resets; this was read as \"distance went backwards\" and the WHOLE lap was re-modelled from speed instead. Because the start/finish crossing lands at a different point of the sampling grid from lap to lap, some laps in a stint were scaled by real distance and others by a modelled one, so trace comparison drifted silently. A genuine glitch in the MIDDLE of a lap still falls back to speed.",
      "🧊 THE `--no-rest` FLAG DID NOTHING IN THE UI PATH. This flag exists to switch LMU REST off when the game stutters, but it was silently ignored on the default double-click path and in the `--dump` / `--dump-wx` diagnostic commands — so the command you run to investigate stutter was itself triggering the known cause. It now applies on every path, and the bridge window and log state the real REST status. (REST staying ON by default in the UI was kept; the docs were updated to match today's behaviour.)",
    ],
  },
  {
    v: "v2.4.0",
