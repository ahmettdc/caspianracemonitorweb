...
export const CHANGELOG = [
  {
    ...
    tr: [
      ...
      "🔧 PİT sütununa SON DURAKTA DEĞİŞEN LASTİK rozeti eklendi: '4', '2 ÖN' ya da yakıt-only durakta '0'. Rakibin undercut mu yoksa yalnız yakıt için mi durduğu artık tabloda görünüyor. Ayrıca garajdaki araçlar pit yolundakilerden ayrıldı (GRJ / PIT).",
    ...
    en: [
      ...
      "🔧 The PIT column gained a LAST-STOP TYRE CHANGE badge: '4', '2 FRONT', or '0' for a fuel-only stop. Whether a rival undercut or only stopped for fuel is now visible in the table. Cars in the garage are also distinguished from cars in the pit lane (GRJ / PIT).",
