...
export const CHANGELOG = [
  {
    ...
    tr: [
      ...
      "🎛 'Poz · Sınıf' başlığına basınca açılan 'kendi sınıfım' süzgeci artık PİST HARİTASINI da süzüyor. Önceden tablo kendi sınıfınıza iniyordu ama harita tüm sahayı göstermeye devam ediyordu; iki panel aynı ekranda farklı şey anlatıyordu. Not: harita şekli yine tüm araçlardan oluşturuluyor, süzgeç yalnız görünen araçları etkiliyor.",
    ...
    en: [
      ...
      "🎛 The 'my class only' filter (the 'Pos · Class' header) now filters the TRACK MAP as well. Previously the table narrowed to your class while the map kept showing the whole field, so the two panels told different stories. Note: the map outline is still built from every car — the filter only affects which cars are shown.",
