...
export const CHANGELOG = [
  {
    ...
    tr: [
      ...
      "🛞 Kendi araç için lastik & hasar diyagramı: üstten görünüş araç, lastikler aşınmaya göre renkli (compound kenarlığı), gövde tonu hasara göre",
    ...
    en: [
      ...
      "🛞 Tyre & damage diagram for your car: top-down car, tyres colored by wear (compound-colored border), body tint by damage",
