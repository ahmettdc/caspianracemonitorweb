...
export const EN = {
  ...
  "Sıradaki Pit": "Next Pit", "Direksiyonda": "At the Wheel", 
  ...
  "VE İht.": "VE Req.", "Pit Ayarı": "Pit Setup",
  /* --- rehber turu --- */
  ...
  "Zemin / Hava": "Track / Weather", "Efektif tur": "Effective lap", 
  ...
  "Planlı geçiş ekle": "Add planned change", 
  ...
  "Tur override aktif — önce onu temizle": "Lap override active — clear it first", "Hava Geçmişi": "Weather History", "Tümünü Sıfırla": "Reset All", 
  ...
  "Tarih": "Date", "Sınıf": "Class", "Yarış": "Race",
  "Takıma Yükle": "Upload to Team", 
  ...
  "Önler": "Fronts", "Arkalar": "Rears", "Sollar": "Lefts",
  ...
  // --- Sürücü modu (v2.3.1) ---
  "Race Monitor kapanacak ve tarayıcısız hafif köprü açılacak. Köprü bağımsız çalışır, veri akışı kesilmez — köprü penceresindeki \"Race Engineer'a Dön\" ile geri dönebilirsin.": "Race Monitor will close and the browserless lightweight bridge will start. The bridge runs independently, so the data keeps flowing — you can come back with \"Back to Race Engineer\" in the bridge window.",
  "Sürücü moduna geç": "Switch to driver mode",
  ...
  "Başlangıç": "Start", "sürüyor": "ongoing",
  ...
  "yarış": "race",
  "uygun değil": "unavailable",
  // --- Strateji Karşılaştırma (v2.4.0) ---
  "Strateji Karşılaştırma": "Strategy Comparison",
  "Yarış öncesi hesap aracı — canlı veri kullanmaz": "Pre-race calculator — uses no live data",
  ...
  "Sabit kayıp": "Fixed loss",
  "Tempo (ort. tur × tur)": "Pace (avg lap × laps)", "TOPLAM": "TOTAL",
  ...
  "Tüm defter — tahmini bitiş sırası": "Whole register — projected finishing order",
  "Lidere fark": "Gap to leader", "lider": "leader",
  "Sıralamaya girmeyen (eksik veri)": "Not ranked (missing data)",
  "Stint sayısı pit sayısı + 1 olmalı": "Stint count must be pit count + 1",
  "Lastik değişimi durak sayısını geçemez": "Tyre changes cannot exceed pit stops",
  "Bizim takım": "Our team",
  // kayıt defteri sütunları
  "Pit yolu": "Pit lane", "Yakıt (tam)": "Fuel (full)", "Yakıt (son pit)": "Fuel (last pit)",
  "Lastik süresi": "Tyre time", "Lastik adedi": "Tyre changes",
  "Ceza süresi": "Penalty time", "Hasar süresi": "Damage time", "Balast": "Ballast",
  "Durak sayısı": "Number of pit stops", "Stint sayısı (= pit + 1)": "Stint count (= pits + 1)",
  "Pit yolu geçiş süresi (sn)": "Pit lane transit time (s)",
  "Tam servis yakıt süresi (sn)": "Full-service refuel time (s)",
  "Son durakta yalnız bitirmeye yetecek yakıt alınır — kısa sürer":
    "The last stop only takes on enough fuel to finish — it is shorter",
  "Bir değişimin süresi (sn)": "Time for one tyre change (s)",
  "Lastik değişen durak sayısı": "Number of stops where tyres are changed",
  "Ceza süresi (sn) — boş = ceza yok": "Penalty time (s) — blank = no penalty",
  "Hasar/tamir süresi (sn) — boş = hasar yok": "Damage/repair time (s) — blank = no damage",
  ...
  // --- Strateji Karşılaştırma v2.4.0 tasarım fişi ---
  "Araç no": "Car no",
  "Araç seç": "Pick a car",
  "Bilgi amaçlı — hesaba GİRMEZ": "Informational — NOT part of the calculation",
  "Boş ceza ve hasar 0 sn sayılır. Diğer zorunlu alanlar boşsa o takım hesaplanmaz — eksik veri sıfır varsayılmaz. Ort. tur biçimi m:ss.mmm. Balast bilgi amaçlı, hesaba girmez.": "Blank penalty and damage count as 0 s. If any other required field is blank that team is not calculated — missing data is never assumed to be zero. Avg lap format m:ss.mmm. Ballast is informational and does not enter the calculation.",
  "Ceza süresi (sn) — boş = yok": "Penalty time (s) — blank = none",
  "Eksik alan": "Missing fields",
  "Geride kalan turda": "The trailing one must find",
  "Hasar/tamir süresi (sn) — boş = yok": "Damage/repair time (s) — blank = none",
  "Kalem kalem döküm": "Item-by-item breakdown",
  "Karşılaştırma yapılamıyor": "Cannot compare",
  "Kayıt satırı": "Register row",
  "Lastik ad.": "Tyre ct.",
  "Lastik sn": "Tyre s",
  "Pist seç — pit yolu ve ortalama tur önerisi buradan gelir": "Pick a track — the pit lane and average lap suggestions come from it",
  "Sabit farkı": "Fixed delta",
  "Sabit kayıp dağılımı — süre nereye gidiyor (ortak ölçek)": "Fixed-loss breakdown — where the time goes (shared scale)",
  "Seçilen varyantın plan değerlerini bu satıra yazar; ad boşsa plan adını da koyar.": "Writes the chosen variant's plan values into this row; if the name is blank it sets the plan name too.",
  "Son durakta yalnız bitirmeye yeten yakıt — kısa sürer": "The last stop takes only enough fuel to finish — it is shorter",
  "Sonuç": "Result",
  "Stint planındaki toplam turu buraya yaz": "Copy the total laps from the stint plan",
  "Stint sayısı pit + 1 olmalı": "Stint count must be pits + 1",
  "Strateji planından doldur": "Fill from a strategy plan",
  "Tahmini bitiş": "Projected finish",
  "Takım / plan adı": "Team / plan name",
  "Tempo (ort × tur)": "Pace (avg × laps)",
  "Tempo farkı": "Pace delta",
  "Tüm defter · tahmini bitiş sırası": "Whole register · projected finishing order",
  "Yakıt son": "Fuel last",
  "Yakıt tam": "Fuel full",
  "Yarış öncesi karar aracı · canlı veriye ve köprüye dokunmaz": "Pre-race decision tool · touches neither live data nor the bridge",
  "Zorunlu alan boşsa bu satır hesaplanmaz. Ceza ve hasar boşsa 0 sn sayılır. Balast bilgi amaçlı, hesaba girmez.": "If a required field is blank this row is not calculated. Blank penalty and damage count as 0 s. Ballast is informational and does not enter the calculation.",
  "değerleri düzenle": "edit the values",
  "ort": "avg",
  "sabit": "fixed",
  "satır · rakip ya da kendi A/B planınız": "rows · rivals or your own plan A/B",
  "sn bulmalı": "s per lap",
  "toplam süre = ort. tur × tur + pit yolu + yakıt + lastik + ceza + hasar": "total time = avg lap × laps + pit lane + fuel + tyres + penalty + damage",
  "tur/stint · plandan satır kur": "laps/stint · build a row from the plan",
  "tur/stint — bu satırı plandan doldur": "laps/stint — fill this row from the plan",
  ...
  /* --- v2.4.1: t() çağrısı olup EN karşılığı OLMAYAN anahtarlar. Eksik anahtarda
     t() kaynak metni (Türkçe) döndürüyor → EN modunda ekranda Türkçe kalıyordu.
     Bir kısmında çeviri sözlükte zaten vardı ama anahtar yalnız BÜYÜK/KÜÇÜK HARF
     farkıyla tutmuyordu; çağrı yerindeki Türkçe metni değiştirmek yerine anahtar
     eklendi ki TR görünüm birebir aynı kalsın. --- */
  ...
  "s": "s",
  "kaynak": "source",
  "S1 start lastikleri": "S1 starting tyres",
  "4 yeni": "4 new",
  ...
  "DOLU": "FULL",
  "Yellow": "Yellow",
  "Plana etkisi": "Effect on the plan",
  "plana eklendi": "added to the plan",
  "Lastik limiti · adet": "Tyre limit · sets",
  "Tam depo menzili": "Full-tank range",
  "Fuel ratio · L / %1": "Fuel ratio · L / 1%",
  "Planlanan": "Planned",
  "Tasarruflu": "Saving",
  "Agresif": "Aggressive",
  "Senaryolar": "Scenarios",
  "elle girildi": "entered by hand",
  "stratejisi": "strategy",
  "Plan tablosu": "Plan table",
  "Stint plan tablosu": "Stint plan table",
  "Tur sayısı": "Laps",
  "Son kare": "Last frame",
  "PIT YOLUNDA": "IN PIT LANE",
  "PIT'te": "in the PITS",
  "'dir pistte": "on track for",
  "pistte": "on track",
  "turu atan pilot": "driver who set the lap",
  "Tempolar": "Pace",
  "Bu turda geçilen sektörler (anlık)": "Sectors completed this lap (live)",
  "Sektör sütununu gizle": "Hide the sector column",
  "Sektör sütununu göster": "Show the sector column",
  "genel kanal": "general channel",
  "Kanallar": "Channels",
  "Kodu kopyala": "Copy the code",
  "Kodu yenile": "Regenerate the code",
  "Yenile": "Regenerate",
  "Rol": "Role",
  "Devret": "Transfer",
  "Yeniden davet et": "Invite again",
  "Sezon Takvimi": "Season Calendar",
  "Yeni sezon": "New season",
  "PNG / SVG · en az 256×256": "PNG / SVG · at least 256×256",
  "olarak kurulacak": "will be installed as",
  "Kuruluyor…": "Installing…",
  "Yüklüyor…": "Uploading…",
  "Bitir": "Finish",
  "Duraklat": "Pause",
  "Rehberi atla": "Skip the guide",
  "Sabit setup": "Fixed setup",
  "SR: hepsi": "SR: all",
  "dosya bekleniyor": "waiting for a file",
  "LMU yerel telemetri kaydını (.duckdb) seç": "Pick the LMU local telemetry recording (.duckdb)",
  "Stint izi kaydediliyor": "Saving the stint trace",
  "İz kaydedildi": "Trace saved",
  "sınırlandı": "capped",
  "İz kaydedilemedi": "Could not save the trace",
