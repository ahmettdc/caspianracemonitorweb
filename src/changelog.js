...
export const CHANGELOG = [
  {
    ...
    en: [
      ...
      "🧮 IMPORTANT (plan table): Typing a plain number into a stint's OVERRIDE cell (e.g. \"31\", meaning laps) was read as 31 SECONDS, collapsing that stint to 1 lap; the spilled laps added an extra row and shifted every stint number (the app said stint 8 while you were on 7). Durations shorter than one lap are now ignored, the cell is outlined in red, and the correct format (0:53:15) is explained.",
