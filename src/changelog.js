...
export const CHANGELOG = [
  {
    ...
    en: [
      ...
      "💥 A BLOWOUT MARK was added. When a tyre blows during the race you click the cell and choose \"it blew out in this stint\": the cell gets a dashed red border, the tread bar becomes a hatched \"BLEW OUT\", that box is hatched in the set budget, and an \"N blowouts\" chip appears in the header — so the blown set reads as unusable for the rest of the plan. Note: a blowout currently ADDS NO time to the pit stop (an unplanned stop is not modelled); it is only marked.",
